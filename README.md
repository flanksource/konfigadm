...
```bash
wget https://github.com/moshloop/konfigadm/releases/download/v0.3.4/konfigadm.deb
...
```bash
rpm -i https://github.com/moshloop/konfigadm/releases/download/v0.3.4/konfigadm.rpm
```

### Binary

```bash
wget -O /usr/bin/konfigadm https://github.com/moshloop/konfigadm/releases/download/v0.3.4/konfigadm && chmod +x /usr/bin/konfigadm
```
