...
var images = map[string]Image{
	"ubuntu2004": {
		...
		Tags:           []types.Flag{types.UBUNTU, types.UBUNTU20, types.DEBIAN_LIKE},
	},
	"ubuntu1804": {
		...
		Tags:           []types.Flag{types.UBUNTU, types.UBUNTU18, types.DEBIAN_LIKE},
	},
	"ubuntu1604": {
		...
		Tags:           []types.Flag{types.UBUNTU, types.UBUNTU16, types.DEBIAN_LIKE},
	},
	"debian9": {
		...
		Tags:           []types.Flag{types.DEBIAN, types.DEBIAN9, types.DEBIAN_LIKE},
	},
	"centos7": {
		URL:            "https://cloud.centos.org/centos/7/images/CentOS-7-x86_64-GenericCloud-{{.version}}.qcow2",
		DefaultVersion: "1905",
		Tags:           []types.Flag{types.CENTOS, types.CENTOS7, types.REDHAT_LIKE},
	},
	"amazonLinux": {
