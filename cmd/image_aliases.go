...
var images = map[string]string{
	"ubuntu:1804": "https://cloud-images.ubuntu.com/releases/18.04/release-20190617/ubuntu-18.04-server-cloudimg-amd64.img",
	"ubuntu:1604": "https://cloud-images.ubuntu.com/releases/16.04/release-20190628/ubuntu-16.04-server-cloudimg-amd64-disk1.img",
